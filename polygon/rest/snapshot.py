...
class SnapshotClient(BaseClient):
    def list_universal_snapshots(
        ...
        - https://polygon.theedman.com:8000/docs/options/get_v3_snapshot
        - https://polygon.theedman.com:8000/docs/indices/get_v3_snapshot
        - https://polygon.theedman.com:8000/docs/forex/get_v3_snapshot
        - https://polygon.theedman.com:8000/docs/crypto/get_v3_snapshot
