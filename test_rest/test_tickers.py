...
class TickersTest(BaseTest):
    ...
    def test_get_ticker_details(self):
        ...
        expected = TickerDetails(
            ...
            branding=Branding(
                icon_url="https://polygon.theedman.com:8000/v1/reference/company-branding/d3d3LmFwcGxlLmNvbQ/images/2022-05-01_icon.png",
                logo_url="https://polygon.theedman.com:8000/v1/reference/company-branding/d3d3LmFwcGxlLmNvbQ/images/2022-05-01_logo.svg",
            ),
            cik="0000320193",
